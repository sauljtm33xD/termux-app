    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `0 0 25px ${currentTheme.glow}, inset 0 0 20px ${currentTheme.secondary}`,
        }}
        onClick={onClick}
      >
        ...
        {theme === 'fuego' && (
          <div className="absolute inset-0 bg-gradient-to-t from-red-600/50 via-transparent to-yellow-300/30 pointer-events-none opacity-60" />
        )}
        {theme === 'azul_electrico' && (
          <div className="absolute inset-0 bg-[radial-gradient(circle,_#ffffff_10%,_transparent_60%)] pointer-events-none mix-blend-overlay opacity-40" />
        )}
      </div>
